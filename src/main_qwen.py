...
if __name__ == "__main__":
    ...
    for model in ["Qwen/Qwen3-30B-A3B"]:
        for dataset_name, domain in [ ('amazon_FF', 'amazon fine foods reviews'), ("hotels", "hotel reviews"), ("shoes", "shoes reviews"), ("rest15", "restaurant reviews"), ("rest16", "restaurant reviews")] :
            task = "cot_chainer"
